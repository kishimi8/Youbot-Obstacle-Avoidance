...
distance1 = dst_pt_line(s1.vertex(0),s1.vertex(1),pt);
distance2 = dst_pt_line(s2.vertex(0),s2.vertex(1),pt);
distance3 = dst_pt_line(s3.vertex(0),s3.vertex(1),pt);
distance4 = dst_pt_line(s4.vertex(0),s4.vertex(1),pt);
return distance1;
}
