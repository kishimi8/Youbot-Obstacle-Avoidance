...
void dst_from_obs(Listener &p, Polygon_2 pgn_1, Polygon_2 pgn_2, Polygon_2 pgn_3, Polygon_2 pgn_4, Point_2 &pt_cl)
{
...
d1 = dst_pt_pgn(pgn_1, fl, p1);
d2 = dst_pt_pgn(pgn_2, fl, p2);
d3 = dst_pt_pgn(pgn_3, fl, p3);
d4 = dst_pt_pgn(pgn_4, fl, p4);
...
dst_from_obs(pose, pgn_1,pgn_2,pgn_3,pgn_4,nearest);
